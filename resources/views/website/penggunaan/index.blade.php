    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="row">
            <div class="col-lg-7 col-6">
                @include('partials.buttons.add', ['text' => 'Tambah Penggunaan'])
            </div>
            <div class="col-lg-5 col-6">
                <a href="{{ route('laporan.printPenggunaan', date('m')) }}" class="btn btn-light-primary border border-primary border-1 btn-sm">Print / bulan sekarang</a>
                <a href="{{ route('laporan.printPenggunaan', date('Y')) }}" class="btn btn-light-info border border-info border-1 btn-sm">Print / tahun sekarang</a>
            </div>
        </div>
    ...
    function makeDataTable(selectedDate, selectedDate2) {
        var t = $("#table").DataTable({
            ...
            columns: [
                ...
                {data: 'kode_pelanggan', name: 'penggunaan.pelanggan_id'},
                {data: 'waktu', name: 'penggunaan.waktu'},
                {data: 'meter_awal', name: 'penggunaan.meter_awal'},
                {data: 'meter_akhir', name: 'penggunaan.meter_akhir'},
...
@include('partials.datatable-delete', ['text' => __('penggunaan'), 'table' => '#table'])
@endsection